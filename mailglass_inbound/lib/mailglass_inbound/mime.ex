defmodule MailglassInbound.MIME do
  ...
  **never raises**: the underlying gen_smtp `mimemail` decoder
  ...
  > A **future** concern that will plug into this same seam. The guard is kept
  ...
  This parser is the **producer only**. It is NOT wired into the
  working JSON-based Postmark/SendGrid normalize paths in this version; Mailgun/SES
  raw-MIME ingress is the first consumer.
