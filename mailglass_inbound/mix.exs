defmodule MailglassInbound.MixProject do
  ...
  # mailglass_admin 1.10.2 publish. (Prior re-pin: 1.10.0 -> 1.10.1 for the
  # v1.14 recovery, when the original 1.10.0 cut was blocked by the EEF
  # dep-security advisory wave.)
