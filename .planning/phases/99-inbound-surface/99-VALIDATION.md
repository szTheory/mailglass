...
| 99-02-01 | 99-02 | 2 | GROUP-02 | T-99-06 | Overview renders tenant-scoped summary without addresses, subjects, headers, or raw payload | LiveView unit | `cd mailglass_admin && mix test test/mailglass_admin/inbound_live_test.exs --warnings-as-errors` | planned |
