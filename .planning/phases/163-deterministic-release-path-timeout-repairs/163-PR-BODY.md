...
- reproduces protected matrix expiries and repairs only five exact test titles plus browser sandbox ownership with finite bounds;
...
- `CI=true npm run test:operator-browser`: 176 passed, 1 skipped in 3.7m, no retry;
- three first-attempt focused gallery runs passed with all 117 cells;
- exact-code protected run `33002642359` passed both Core Deterministic and Operator Browser jobs;
