...
| 28 | T-164-109 | Repudiation | no-later-write evidence | high | mitigate | Keep report ignored and document/test that no tracked artifact or metadata action follows capture. Audit: terminal protected evidence is absent; tracked source now covers Plan 44 while installed authority remains at Plan 39 pending approval. | open |
