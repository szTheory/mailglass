...
| 82-02-01 | 02 | 2 | LOGO-02 | T-82-06 / T-82-07 / T-82-08 | Maintainer selection/refinement is recorded before final assets are claimed | manual gate + source grep | `test -f brandbook/logo-options.md && xmllint --noout brandbook/assets/options/*.svg && rg -n 'Direction A|Direction B|Direction C|folded pane|message-lines|inspection pane|16px|32px|Maintainer review|Selected direction|Recommended final refinement' brandbook/logo-options.md` | missing until Plan 01 | pending |
