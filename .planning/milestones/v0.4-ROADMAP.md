...
| 24 | Complete | Add tenant-safe webhook replay with durable audit context. | `REPLAY-01`, `REPLAY-02`, `REPLAY-03` |
| 25 | Complete | Ship `mix mail.doctor` with actionable DNS deliverability diagnostics. | `DOCTOR-01`, `DOCTOR-02`, `DOCTOR-03` |
| 26 | Complete | Add runtime per-tenant adapter resolution without breaking single-tenant defaults. | `TENANT-01`, `TENANT-02`, `TENANT-03` |
| 27 | Complete | Close the known install and post-publish smoke gaps before milestone ship. | `REL-17`, `REL-18` |
