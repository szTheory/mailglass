...
- [x] **FACADE-01**: Every `Mailglass.Repo` delegated call (`insert/update/delete/one/all/get/aggregate/
...
- [x] **FACADE-02**: Every `Ecto.Multi` builder that writes a mailglass table
