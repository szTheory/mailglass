...
- [x] **SHELL-01**: The sidebar nav shows the correct active item for the current surface
      (overview / deliveries / inbound) — never a false highlight.

- [x] **SHELL-02**: The Overview is a **real triage destination**: redundant "Navigate" nav cards
...
- [x] **SHELL-03**: Shell + overview microcopy is streamlined, on-brand, and non-redundant (no
