...
- ✅ **v1.8 Brand System and Repo-Ready Brandbook** - Phases 80-84 (closed superseded 2026-06-10; audit verdict gaps_found, see [milestones/v1.8-MILESTONE-AUDIT.md](milestones/v1.8-MILESTONE-AUDIT.md))
...
- [x] 82-02-PLAN.md — Maintainer selected `concept-07r-no-idot-02-tighter-gap`
  out-of-band (see 82-02-SUMMARY.md); G-R set is rejected evidence.

**Wave 3**

- [x] 82-03-PLAN.md — Canonical assets promoted and brand docs rewritten
  out-of-band (see 82-03-SUMMARY.md); frozen at commit `09a84dd4`.
...
**Status:** Superseded — 2026-06-10 (intent substantially satisfied out-of-band
in the frozen baseline `09a84dd4`: specimens exist under `brandbook/examples/`;
copy blocks partially covered in `brandbook/brand-book.md`. Residual gaps are
recorded in the v1.8 milestone audit and inherited by the v1.9 milestone.)
...
**Status:** Superseded — 2026-06-10 (partial out-of-band coverage in the frozen
baseline: xmllint/unsafe-construct/stale-reference scans ran; contrast
validation never ran and `tokens.json` still references it. Residual gaps are
recorded in the v1.8 milestone audit and inherited by the v1.9 milestone.)
...
| 82 | Logo and SVG Asset System | Complete — 2026-06-10 (out-of-band) |
| 83 | Visual Specimens and Copy Blocks | Superseded — 2026-06-10 |
| 84 | Quality Gate and Repo Hygiene | Superseded — 2026-06-10 |
