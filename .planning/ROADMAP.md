...
- [x] 106-01-PLAN.md — Write guides/production-go-live-checklist.md + guides/errors-and-troubleshooting.md (OPS-01, OPS-02)
- [x] 106-02-PLAN.md — mix.exs dual registration + docs-contract assertions + api_stability.md minimal correction (OPS-01, OPS-02)
