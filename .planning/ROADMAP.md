...
- [ ] **Phase 141: Lane Truth Foundation** - Reconcile the three disagreeing "advisory" registries into one, classify the hidden third gating tier, rename the misleading "Credo Strict" lane with an explicit required/advisory/neither decision, record every lane's disposition, and restore the deleted v2.0 phase archives
- [ ] **Phase 142: Supply-Chain Remediation & Gating** - Wire the accepted-advisory allowlist into the CI-side audit lane first, then promote Hex Audit + Deps Audit to merge-gating, disposition the dependabot backlog, and document a triage cadence covering transitive dependencies
...
|-------|----------------|--------|-----------|
| 141. Lane Truth Foundation | 6/6 | In Progress|  |
