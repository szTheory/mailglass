...
- [x] 99-03-PLAN.md - RoutingTrace/EvidenceCard group layout and token cleanup.
...
- [x] 99-05-PLAN.md - Fail-closed type/tracking conformance gate and rebuilt bundle.
**UI hint**: yes
...
- [x] 100-01-PLAN.md — Split Preview admin chrome theme from previewed Message/frame theme.

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 100-02-PLAN.md — Compose responsive Preview IA/groups, locked copy, hooks, touch targets, and rebuilt CSS.
