...
- [x] **QUAL-03**: Deterministic core/inbound suites, warning/no-optional builds, support contracts, Mix tasks, Credo, conformance, Dialyzer, docs, audits, trust, and installer smoke all block code merges through `CI Green`.
...
- [x] **QUAL-09**: Every skipped/flaky test has an owner, reason, and expiry; expired entries fail CI, and async behavior tests use deterministic acknowledgements instead of sleeps/permissive states.
...
*Last updated: 2026-08-21 after the passing milestone integration re-audit.*
