...
| GAP-06 | deliveries | mailglass_admin/operator_live.ex:397 | Spacing | 4 | tmp/ui-audit/deliveries-768-light.png | Master-detail grid uses lg:grid-cols-[minmax(22rem,28rem)_1fr], violating IA-LD-03 percentages and the 768 tier; replace with md:grid-cols-[40%_60%], a 1440 tier, and 390px reveal-with-back. | open | 2026-06-14-phase-98 | 2026-06-14-phase-98 |
| GAP-07 | deliveries | mailglass_admin/operator_live.ex:404 | Type | 3 | tmp/ui-audit/deliveries-768-light.png | Deliveries-list card heading and in-pane labels carry arbitrary tracking-[0.08em], violating IA-LD-04 / STATE-LD-13; replace with text-label uppercase font-bold text-secondary token. | open | 2026-06-14-phase-98 | 2026-06-14-phase-98 |
| GAP-08 | deliveries | mailglass_admin/operator/deliveries_list.ex:15 | Type | 3 | tmp/ui-audit/deliveries-390-light.png | Empty branch renders one generic copy and cannot distinguish filtered-empty with reset action from truly-empty; thread filters_active? from operator_live.ex and split COPY-LD-01 / COPY-LD-02 states. | open | 2026-06-14-phase-98 | 2026-06-14-phase-98 |
| GAP-09 | deliveries | test/support/operator_fixtures.ex | Motion+A11y | 3 | tmp/ui-audit/deliveries-390-light.png | Single seed does not reach :suppressed, detail-error, filtered-empty, or truly-empty states by URL; extend the one seeded dataset with hours_ago(7)+ rows and add per-state Playwright assertions. | open | 2026-06-14-phase-98 | 2026-06-14-phase-98 |
