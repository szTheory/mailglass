...
| GAP-05 | all | mailglass_admin_web/router.ex | Motion+A11y | 2 | — | Add route /dev/mail/gallery (Phase 97, dev live_session only); gallery surface structural assertions are skipped in structural.spec.js until Phase 97 ships the component gallery | open | 2026-06-13-phase-95-baseline | 2026-06-13-phase-95-baseline |
