...
[
  ...
  },
  {
    ...
    "status": "waived",
    "reason": "No recurrence across the v2.8 full-suite and PR matrices; retain as historical transient evidence and reopen only if the LeakError recurs.",
    "recorded_at": "2026-07-30T02:31:56.233Z",
    "resolved_at": "2026-09-19T14:05:44.121Z"
  },
  {
    "id": 7,
    "kind": "deviation",
  ...
  },
  {
    ...
    "status": "waived",
    "reason": "Confirmed substantive pre-v2.8 harness debt requiring a dedicated future phase; fixing it would activate broad pre-existing violations outside the 17-requirement milestone.",
    "recorded_at": "2026-07-30T21:11:45.856Z",
    "resolved_at": "2026-09-19T14:05:44.238Z"
  },
  {
    "id": 13,
    "kind": "unmet-truth",
    ...
    "status": "waived",
    "reason": "Confirmed substantive pre-v2.8 harness-liveness debt requiring a dedicated future phase; not safe to patch as milestone cleanup.",
    "recorded_at": "2026-07-30T21:11:45.918Z",
    "resolved_at": "2026-09-19T14:05:44.354Z"
  },
  {
    "id": 14,
    "kind": "unmet-truth",
    ...
    "status": "waived",
    "reason": "Confirmed real sandbox-leak debt coupled to the formatter repair in window 12; defer together to a dedicated harness-truth phase.",
    "recorded_at": "2026-07-30T21:11:45.979Z",
    "resolved_at": "2026-09-19T14:05:44.474Z"
  },
  {
    "id": 15,
    "kind": "unmet-truth",
    ...
    "status": "waived",
    "reason": "Confirmed concurrent application-env policy debt; requires coordinated async/test ownership changes outside v2.8 scope.",
    "recorded_at": "2026-07-30T21:11:46.041Z",
    "resolved_at": "2026-09-19T14:05:44.588Z"
  },
  {
    "id": 16,
    "kind": "unmet-truth",
    ...
    "status": "waived",
    "reason": "Confirmed tenancy env drift coupled to window 15; defer to the same dedicated harness-truth phase.",
    "recorded_at": "2026-07-30T21:11:46.106Z",
    "resolved_at": "2026-09-19T14:05:44.705Z"
  },
  {
    "id": 17,
    "kind": "unrun-verify",
    ...
    "status": "waived",
    "reason": "Requires a real release SHA; v2.8 explicitly will not initiate a release to manufacture verification. Reopen at the next independently wanted release.",
    "recorded_at": "2026-07-31T15:09:13.616Z",
    "resolved_at": "2026-09-19T14:05:44.821Z"
  },
  {
    "id": 18,
    "kind": "lint-warning",
    ...
    "status": "waived",
    "reason": "Advisory-only suite-floor rebaseline requires its own measured CI protocol; defer rather than mix threshold maintenance into v2.8 closeout.",
    "recorded_at": "2026-07-31T15:09:13.698Z",
    "resolved_at": "2026-09-19T14:05:44.937Z"
  },
  {
    "id": 19,
    "kind": "deviation",
    ...
    "resolved_at": "2026-09-19T14:03:49.160Z"
  },
  {
    "id": 20,
    "kind": "unrun-verify",
    ...
    "resolved_at": "2026-09-19T14:05:44.006Z"
  },
  {
    "id": 21,
    "kind": "unrun-verify",
  ...
  },
  {
    ...
    "file": "test/scripts/phase_164_closeout_test.exs",
    "line": null,
    "description": "Consolidated argv, environment, and remote-relation assertions to preserve the five-test repository-attack contract",
    "status": "fixed",
    "reason": "",
    "recorded_at": "2026-09-12T03:12:39.474Z",
    "resolved_at": "2026-09-12T03:14:01.534Z"
  },
  {
    "id": 35,
    "kind": "deviation",
    ...
    "file": "test/support/suite_floor.ex",
    "line": 249,
    "description": "Extended installed-boundary exclusion compatibility contracts for Phase 165",
    "status": "fixed",
    "reason": "",
